...
venue: "UMass Amherst"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Du Bois Library"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "February 01 - 02, 20*"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Thea"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
